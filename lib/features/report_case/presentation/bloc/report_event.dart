...
final class ReportEyeColorChanged extends ReportEvent {
  final String value;
  const ReportEyeColorChanged(this.value);
  @override
  List<Object?> get props => [value];
}

final class ReportHairColorChanged extends ReportEvent {
  final String value;
  const ReportHairColorChanged(this.value);
  @override
  List<Object?> get props => [value];
}
